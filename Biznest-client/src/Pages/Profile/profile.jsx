    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center">
              ...
              <p className="text-sm text-red-800">
                <span className="font-medium">Account Restricted:</span> Your
                account has been temporarily restricted. Please contact support
                for assistance.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card-biznest p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p
                  className={`text-gray-900 bg-gray-50 p-3 rounded-lg font-medium ${user.ban_status ? "text-red-600" : "text-green-600"}`}
                >
          ...
          {user.role?.type === "customer" && <PaymentHistory />}
          ...
          <div className="card-biznest p-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <SecondaryButton>Privacy Settings</SecondaryButton>
              <a href="/profile/contact-messages">
                <SecondaryButton>📧 View Contact Messages</SecondaryButton>
              </a>
