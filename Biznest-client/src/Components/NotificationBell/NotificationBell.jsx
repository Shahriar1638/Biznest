    ...
    const fetchNotifications = async () => {
        ...
        try {
            ...
            if (user.role?.type === 'admin') {
                ...
                response = await axiosPublic.get(`/public/contacts/${user.email}`);
                const userMessages = response.data.data || [];
                
                const unreadReplies = userMessages.filter(msg => 
                    msg.reply
                );
                                            ...
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-gray-600 mt-1">
                                                        <strong>Subject:</strong> {truncateText(notification.subject, 30)}
                                                    </div>
                                                    {notification.reply && (
                                                        <div className="text-xs text-gray-500 mt-1">
                                                            <strong>Reply:</strong> {truncateText(notification.reply, 35)}
                                                        </div>
                                                    )}
